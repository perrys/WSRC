...
setup(name='WSRC',
      ...
      packages=['wsrc', 
                ...
                'wsrc.site.templates.admin.usermodel'],
      package_dir = {'wsrc': 'modules/wsrc',
                     ...
                     'wsrc.site.templates.admin.usermodel':   'modules/wsrc/site/templates/admin/usermodel',
                     },
      package_data = {'wsrc.site': ['templates/*.html'],
                      'wsrc.site.templates.admin.usermodel': ['player/*.html'],
